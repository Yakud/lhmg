	...
	*/
	...
	$.slimbox = function (_images, startImage, _options) {
		options = $.extend({
			...
			overlayOpacity: 0.15,		// 1 is opaque, 0 is completely transparent (change the color in the CSS file)
			overlayFadeDuration: 00,	// Duration of the overlay fade-in and fade-out animations (in milliseconds)
			resizeDuration: 00,		// Duration of each of the box resize animations (in milliseconds)
			resizeEasing: "fadeIn",		// "swing" is jQuery's default easing
			...
			imageFadeDuration:00,		// Duration of the image fade-in animation (in milliseconds)
			captionAnimationDuration: 00,		// Duration of the caption animation (in milliseconds)
